...
clock = time.Clock()
colors = [(randint(0,255), randint(0,255), randint(0,255)), (randint(0,255), randint(0,255), randint(0,255)), (randint(0,255), randint(0,255), randint(0,255)), (randint(0,255), randint(0,255), randint(0,255))]
...
cells = [Ball(randint(-2000, 2000), randint(-2000, 2000), randint(10, 30), choice(colors)) for _ in range(300)]
f = font.Font(None, 50)
running = True
lose = False
